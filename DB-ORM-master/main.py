...
# Director.objects.create(name = '이순철', debut = '2022-01-01', country = 'KOR')

de = Director.objects.get(name = '이다온')
de.delete()

# direct = Director.objects.get(name = '이순철')
# print(direct.name, direct.debut, direct.country)
# direct.name = '이다온'
# direct.debut = '2017-02-23'
# direct.save()
# print(direct.name, direct.debut, direct.country)
